...
public class MiniPID{
	...
	private LinkedList<Double> lastActual = new LinkedList<>();
	...
	public double getOutput(double actual, double setpoint){
		...
		Doutput= -D*(actual-lastActual.get(0));
		lastActual.add(actual);
		if(lastActual.size() > 10) {
			lastActual.remove();
		}
	...
	public double getOutput(){
		return getOutput(lastActual.get(0),setpoint);
	}
